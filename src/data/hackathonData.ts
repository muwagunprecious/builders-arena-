...
export const BUILDER_PROFILES: BuilderProfile[] = [
  ...
  },
  {
    ...
    category: 'organizer',
    organization: 'OOU Tech Community',
    bio: 'Backend architect and DevOps specialist organizing technical infrastructure for Builders Arena.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=600&auto=format&fit=crop',
    skills: ['Cloud Architecture', 'Python', 'DevOps'],
    badge: 'ORGANIZER',
  },
  {
    id: 'otc-team-2',
    ...
    category: 'organizer',
    organization: 'OOU Tech Community',
    bio: 'Product designer focusing on high-contrast cyber visuals and seamless builder UX.',
    avatarUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=600&auto=format&fit=crop',
    skills: ['UI/UX', 'Design Systems', 'Brand Strategy'],
    badge: 'ORGANIZER',
  },
  {
    id: 'mentor-1',
    ...
    category: 'mentor',
    organization: 'Lead AI Engineer @ TechCo',
    bio: 'Guiding teams building LLM agents and local language processing solutions.',
  ...
  {
    id: 'judge-1',
    name: 'Bisi Onabanjo-Aina',
    role: 'Venture Partner & Judge',
    category: 'judge',
    organization: 'Fintech VC Africa',
    bio: 'Evaluating business models, market viability, and scalable execution for finalist solutions.',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=600&auto=format&fit=crop',
    skills: ['Venture Capital', 'Fintech', 'Market Strategy'],
    badge: 'JUDGE',
  },
  {
    id: 'speaker-1',
    name: 'Kemi Balogun',
    role: 'Web3 Security Speaker',
    category: 'speaker',
    organization: 'Polygon Africa',
    bio: 'Delivering keynote on decentralized digital identity and smart contract auditing.',
